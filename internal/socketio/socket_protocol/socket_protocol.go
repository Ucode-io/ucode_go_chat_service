...
func WriteTo(w io.Writer, t PacketType, nps string, arg ...any) (int64, error) {
	writer := writer{
		t:   t,
		nps: nps,
		ack: "",
...
func WriteToWithAck(w io.Writer, t PacketType, nps string, ack string, arg ...any) (int64, error) {
	writer := writer{
		t:   t,
		nps: nps,
		ack: ack,
